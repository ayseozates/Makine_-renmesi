function [trainedModel, validationRMSE] = lineerRegressionModel(trainingData)
...
% Auto-generated by MATLAB on 11-May-2021 00:30:59
...
trainedModel.RequiredVariables = {'TV', 'newspaper', 'radio'};
...
for fold = 1:KFolds
    ...
    concatenatedPredictorsAndResponse.sales = trainingResponse;
    linearModel = fitlm(...
        concatenatedPredictorsAndResponse, ...
        'linear', ...
        'RobustOpts', 'off');
